...
class AddStockScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: F_AddStockScreen(title: title,),
    );
  }
}
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  SizedBox(height: 20,),
                  Text("New ${widget.title} to be added",style: titleStyle,),
                  SizedBox(height: 15,),
                  TextFormField(
                    ...
                    obscureText: false,
                    validator: (value) => value.isNotEmpty ? null : '${widget.title} cant\'t be empty.',
                  ...
                  SizedBox(height: 20,),
                  Text("${widget.title}'s which you have",style: titleStyle,),
                  SizedBox(height: 15,),
                  Container(
                    child: Column(
