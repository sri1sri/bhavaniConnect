...
class TermsAndConditions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: F_TermsAndConditions(),
    );
  }
}

class F_TermsAndConditions extends StatefulWidget {
  @override
  _F_TermsAndConditionsState createState() => _F_TermsAndConditionsState();
}

class _F_TermsAndConditionsState extends State<F_TermsAndConditions> {
