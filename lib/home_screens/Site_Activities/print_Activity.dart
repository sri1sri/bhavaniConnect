...
class PrintActivity extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: F_PrintActivity(),
    );
  }
}

class F_PrintActivity extends StatefulWidget {
  @override
  _F_PrintActivity createState() => _F_PrintActivity();
}

class _F_PrintActivity extends State<F_PrintActivity> {
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (context) => PrintPreview(),),
                              );
                            },
                            child: Container(
