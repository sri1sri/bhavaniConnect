...
class ActivityDetailDescription extends StatefulWidget {
  ...
  const ActivityDetailDescription(
      {Key key, this.currentUserId, this.documentId})
      : super(key: key);

  @override
  _ActivityDetailDescription createState() => _ActivityDetailDescription();
}

class _ActivityDetailDescription extends State<ActivityDetailDescription> {
  int index = 0;
  int totalProgress = 0;
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                subtext(
                                  "Sub Category",
                                  result[0]['sub_category']['subCategoryName'],
                                ),
                                subtext("Uom", result[0]['unit']['unitName']),
                                Divider(
                                  thickness: 1,
